    ...
    <div className={`${styles.new} bg-gray-900 border-gray-700 flex items-center justify-center relative`}>
      <form onSubmit={handleSubmit} className="max-w-md w-full p-8 rounded-lg shadow-md">
        ...
        <div className="flex items-center mb-4">
          ...
          />
          <label htmlFor="deadline_box" className="ms-2 text-sm font-medium text-gray-200 dark:text-gray-300">
            Has deadline
          </label>
        </div>
        ...
        <div className="flex items-center mb-4">
          <input
            ...
            className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
          />
          <label htmlFor="public" className="ms-2 text-sm font-medium text-gray-200 dark:text-gray-300">
            Public
          </label>
        </div>
